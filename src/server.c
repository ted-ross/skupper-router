...
qd_connection_t *qd_server_connection_impl(qd_server_t *server, qd_server_config_t *config, qd_connection_t *ctx, qd_connector_t *connector)
{
    ...
    sys_mutex_init(&ctx->inbound_cutthrough_lock);
    sys_mutex_init(&ctx->outbound_cutthrough_lock);
...
static void qd_connection_free(qd_connection_t *qd_conn)
{
    ...
    sys_mutex_free(&qd_conn->inbound_cutthrough_lock);
    sys_mutex_free(&qd_conn->outbound_cutthrough_lock);
...
void qd_server_free(qd_server_t *qd_server)
{
    ...
    while (ctx) {
        ...
        sys_mutex_free(&ctx->inbound_cutthrough_lock);
        sys_mutex_free(&ctx->outbound_cutthrough_lock);
